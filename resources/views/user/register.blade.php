    ...
    <section class="mt-10">
        <form action="" class="flex flex-col">
            <div class="mb-6 py-2 rounded bg-gray-200 items-center">
                ...
                <input type="text" class="bg-gray-200 p-2 border-b-4 w-full focus:outline-none">
            </div>
            <div class="mb-6 py-2 rounded bg-gray-200 items-center">
                <label for="email" class=" text-gray-700 text-sm flex items-center justify-start p-3">Email</label>
                <input type="email" class="bg-gray-200 p-2 border-b-4 w-full focus:outline-none">
            </div>
            <div class="mb-6 py-2 rounded bg-gray-200 items-center">
                <label for="password"
                    class=" text-gray-700 text-sm flex items-center justify-start p-3">Password</label>
                <input type="password" class="bg-gray-200 px-2 border-b-4 w-full focus:outline-none">
            </div>
            <button
